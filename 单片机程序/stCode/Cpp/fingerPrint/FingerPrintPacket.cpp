/*
 * FingerPrintPacket.cpp
 *
 *  Created on: 2017Äê9ÔÂ4ÈÕ
 *      Author: Administrator
 */

#include "FingerPrintPacket.h"

static const u8 CRC8Table[] = { 0, 94, 188, 226, 97, 63, 221, 131, 194, 156,
...
u8 FingerPrintPacket::fsmCRC(u8* dat, u32 len) {
	u8 crc8 = 0;
	while (len--) {
...
FingerPrintPacket::FingerPrintPacket() {
	// TODO Auto-generated constructor stub

}

FingerPrintPacket::FingerPrintPacket(u8 packFlag) {
}
